...
const ApiActions = ({actions, setAction, setViewModalOpen}) => {
    ...
    var newActionRows = actions.map((action, index) => {
        ...
        var responseBodySchema = action.responses && action.responses[0] && action.responses[0].schema ? action.responses[0].schema : null
